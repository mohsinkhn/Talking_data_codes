...
if __name__ == "__main__":
    ...
    train = pd.read_csv("../input/train_featureset1.csv", dtype=dtypes)
    
    logger.info("Reading test file")
    test = pd.read_csv("../input/test_featureset1.csv", dtype=dtypes)
